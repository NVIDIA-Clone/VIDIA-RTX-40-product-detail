const Dlss = () => {
    ...
    <div className="grid grid-cols-8 grid-rows-6 gap-4 bg-local text-NVWhiteTxt bg-auto bg-no-repeat bg-[url('/images/nvidia-dlss-video-xlrg-hero-background-bb770-d.jpg')]">
        <div className="col-start-2 col-span-6 row-start-2 row-span-1 justify-self-center">
        ...
        <div className="col-start-4 col-span-2 row-start-3 row-span-1 justify-self-center">
