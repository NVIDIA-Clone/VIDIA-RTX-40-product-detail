  ...
  return (
    <>
      ...
      <div className="w-[858px] font-Sig text-left ml-auto mr-auto mt-[14px]">
        <h3 className="font-semibold text-white text-[22px]">Vidia Studio</h3>
        <h4 className="text-white text-[36px] mt-[10px] font-bold">
          Your Creativity
          <sup>AI</sup>
        </h4>
        <p className="text-[#eee] text-[15px] mt-[10px]">
          Take your creative projects to the next level with VIDIA Studio.
          ...
          creative apps, world-class VIDIA Studio drivers engineered to provide
