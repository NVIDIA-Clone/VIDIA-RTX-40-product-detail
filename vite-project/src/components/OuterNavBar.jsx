const OuterNavBar = () => {
    return (
        <nav className="h-[66px] w-full bg-black text-NVNavBarGray font-Sig flex flex-row items-center" >
                ...
                <ul className="flex">
                    <li className="sub-brand-nav-item"></li>
                        <div className="relative inline-block text-left">
                            <span type="button" id="dropDownHoverBtnProducts" className="inline-flex w-full justify-center gap-x-1.5 pl-3 px-3 py-2 text-sm text-gray-400 hover:text-white" aria-expanded="true" aria-haspopup="true" data-dropdown-toggle="dropDownHoverProducts" data-dropdown-trigger="hover">Products</span>
